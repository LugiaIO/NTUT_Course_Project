...
def getResponsesByEvent(dialogflowModel):
    ...
    if (dialogflowModel.eventName == 'retrieve_responseEvent'):
        dialogflowParameters['id'] = dialogflowModel.parameters['id']
        dialogflowParameters['name'] = dialogflowModel.parameters['name']
        dialogflowParameters['time'] = dialogflowModel.parameters['time']
        dialogflowParameters['end_time'] = dialogflowModel.parameters['end_time']
        dialogflowParameters['location'] = dialogflowModel.parameters['location']
